  ...
  return (
    <div className="card p-5 transition hover:-translate-y-0.5 hover:shadow-xl">
      <div className="flex items-start justify-between gap-3">
        <div>
          <h3 className="font-bold text-navy">{marker.name}</h3>
      ...
      <p className="mt-3 text-sm font-semibold text-slate-500">Ideal: {marker.idealRange}</p>
      <p className="mt-3 text-sm leading-6 text-slate-600">{marker.explanation}</p>
    </div>
  );
}
