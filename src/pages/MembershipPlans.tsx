  ...
  return (
    <div className="space-y-6">
      <div className="gradient-panel rounded-3xl p-8 shadow-soft">
        ...
        <p className="mt-3 max-w-3xl text-white/85">Complete access to connected osteoarthritis monitoring, personalized care planning, and clinician-ready insights.</p>
      </div>
      <div className="grid gap-6 lg:grid-cols-2">
        <div className="card p-6 ring-2 ring-violet/20">
          ...
          <Button className="mt-6 w-full">Subscribe Annual</Button>
        </div>
        <div className="card p-6">
          ...
          <Button className="mt-6 w-full" variant="secondary">Subscribe Monthly</Button>
        </div>
      </div>
      <div className="card p-6">
